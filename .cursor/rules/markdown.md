...
- Links should use [text](mdc:ai-sdlc-playbook/URL) format
- Images should use ![alt text](mdc:ai-sdlc-playbook/imageURL) format

## Documentation Content Organization
- Organize from general to specific, from simple to complex
...
- New documentation should be reviewed by at least one person
