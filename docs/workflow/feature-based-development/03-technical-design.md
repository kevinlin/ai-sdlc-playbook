...
The technical specification should be created after the [Requirement Specification](02-requirement-specification.md) has been defined and approved, as it translates the functional needs into technical implementation details.
...
Once your technical specification is complete, you can proceed with the development phase where both the [Requirement Specification](02-requirement-specification.md) and Technical Design will be used together to guide the AI-powered code generation process.
